...
if __name__=='__main__':
    ...
    daMat,classLablels=loadSimpData()
    # D=mat(ones((5,1))/5)
    # buildStump(daMat,classLablels,D)
    classfierArr=adaBoostTrainDS(daMat,classLablels,9)
    predict=adaClassify([0,0],classifierArr=classfierArr)
    print(predict)
