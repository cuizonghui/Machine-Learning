...
class DecisionTreeClassificationID3:
    ...
    def _get_best_feature(self, features, labels, features_name):
        ...
        for index in range(len(features[0])):
            ...
            information_gain_dict[features_name[index]] = self._information_gain(information_entropy,
...
def main():
    ...
    decision_tree_classification = DecisionTreeClassificationID3()
